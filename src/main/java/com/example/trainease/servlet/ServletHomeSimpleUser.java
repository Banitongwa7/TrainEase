...
@WebServlet(name = "ServletHomeSimpleUser", value = "/ServletHomeSimpleUser")
public class ServletHomeSimpleUser extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/HomeSimpleUser.jsp");
